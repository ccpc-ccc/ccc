...
namespace YF.MWS.Win.Util.CarPlate
{
    ...
    public struct NET_CTRL_OPEN_STROBE
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
        public byte[] szPlateNumber;          // 车牌号码
    }
    ...
    {
        public UInt32 dwSize;
        public EM_NET_AUTHORITY_TYPE emAuthorityType;                          //权限类型
        public bool bAuthorityEnable;                         //权限使能
    }
    ...
    {
        public UInt32 dwSize;
        public Int32 nRecordNo;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)]// 之前查询到的记录号
        public byte[] szMasterOfCar;            // 车主姓名
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]// 之前查询到的记录号
        public byte[] szPlateNumber;            // 车牌号码 
        public EM_NET_PLATE_TYPE emPlateType;                               // 车牌类型
        public EM_NET_PLATE_COLOR_TYPE emPlateColor;                              // 车牌颜色 
        public EM_NET_VEHICLE_TYPE emVehicleType;                             // 车辆类型 
        public EM_NET_VEHICLE_COLOR_TYPE emVehicleColor;                            // 车身颜色
        public NET_TIME stBeginTime;                               // 开始时间
        public NET_TIME stCancelTime;                              // 撤销时间
        public Int32 nAuthrityNum;                              // 权限个数
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)]// 之前查询到的记录号
        public NET_AUTHORITY_TYPE[] stAuthrityTypes;// 权限列表 , 白名单仅有
        public EM_NET_TRAFFIC_CAR_CONTROL_TYPE emControlType;                        // 布控类型 ，黑名单仅有
    }

    // 交通黑白名单账户记录查询条件
    public struct FIND_RECORD_TRAFFICREDLIST_CONDITION
    {
        public UInt32 dwSize;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] szPlateNumber;                // 车牌 号
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] szPlateNumberVague;           // 车牌号码模糊查询
        public Int32 nQueryResultBegin;            // 第一个条返回结果在查询结果中的偏移量 
        public Byte bRapidQuery;                  // 是否快速查询, TRUE:为快速，快速查询时不等待所有增、删、改操作完成。默认为非快速查询
    }
    ...
    public struct NET_IN_FIND_RECORD_PARAM
    {
        ...
        public EM_NET_RECORD_TYPE emType;          // 待查询记录类型
        public IntPtr pQueryCondition; // 查询类型对应的查询条件 
    }
    ...
    {
        public UInt32 dwSize;          // 结构体大小
        public Int32 lFindeHandle;    // 查询记录句柄，唯一标识某次查询
    }
    ...
    {
        public UInt32 dwSize;          // 结构体大小
        public Int32 lFindeHandle;    // 查询句柄
        public Int32 nFileCount;      // 当前想查询的记录条数
    }
    ...
    {
        public UInt32 dwSize;          // 结构体大小
        public IntPtr pRecordList;     // 记录列表，用户分配内存
        public Int32 nMaxRecordNum;   // 列表记录数
        public Int32 nRetRecordNum;   // 查询到的记录条数，当查询到的条数小于想查询的条数时，查询结束
    }

    public struct NET_INSERT_RECORD_INFO
    {
        public UInt32 dwSize;
        public IntPtr pRecordInfo;							// 记录内容信息				
    }
    ...
    {
        public UInt32 dwSize;
        public Int32 nRecordNo;							// 之前查询到的记录号	
    }
    ...
    public struct NET_IN_OPERATE_TRAFFIC_LIST_RECORD
    {
        ...
        public EM_NET_RECORD_TYPE emRecordType;			// 要操作的记录类型
