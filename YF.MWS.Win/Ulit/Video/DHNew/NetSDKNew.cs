...
{
    public static class NETClientNew
    {
        #region << constant >>
        ...
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                if (pInBuf != IntPtr.Zero && pOutBuf != IntPtr.Zero)
                {
                    ...
                    if (returnValue == true)
                    {
                        returnValue = DHOriginalSDK.CLIENT_ParseData(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), IntPtr.Zero);
    ...
    int waittime)
        ...
        {
            bool result = false;
            result = DHOriginalSDK.CLIENT_GetSplitWindowsInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
