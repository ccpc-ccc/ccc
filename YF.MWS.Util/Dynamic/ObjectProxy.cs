...
namespace YF.MWS.Util.Dynamic
{
    ...
    public class ObjectProxy : DynamicObject,IEnumerable
    {
        ...
        public IEnumerable<string> GetDynamicMemberNames(bool declaredOnly)
        {
            return ObjectFactory.GetProperties(type).Where(t => !declaredOnly || t.DeclareType == type).Select(c => c.Name);
        }
