...
namespace YF.MWS.Win.Util
{
    public class DxHelper
    {
        ...
        public static void BindComboBoxEdit(ComboBoxEdit combo, DataTable dt, string textField, string valueField, string seletedValue)
        {
            combo.Properties.Items.Clear();
            ComboBoxItemCollection coll = combo.Properties.Items;
            List<ListItem> lst = new List<ListItem>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                lst.Add(new ListItem()
                {
                    Text = dr[textField].ToObjectString(),
                    Value = dr[valueField].ToObjectString()
                });
                if (dr[valueField].ToObjectString() == seletedValue)
                {
                    selectedItem = new ListItem()
                    {
                        Text = dr[textField].ToObjectString(),
        ...
        public static void BindComboBoxEdit(ComboBoxEdit combo, List<SCode> lstCode, object selectedValue)
        {
            combo.Properties.Items.Clear();
            ComboBoxItemCollection coll = combo.Properties.Items;
            coll.BeginUpdate();
        ...
        public static void BindComboBoxEdit(ComboBoxEdit combo, List<ListItem> lst, string seletedValue = null)
        {
            combo.Properties.Items.Clear();
            ComboBoxItemCollection coll = combo.Properties.Items;
            coll.BeginUpdate();
        ...
        /// By zhao 20110316
        /// </summary>
        public void SetGridView(List<GridView> gvs)
        {
            foreach (GridView v in gvs)
                SetGridView(v);
        }
        ...
        public static string GetStrValue(ComboBoxEdit combo)
        {
            string value = string.Empty;
            try
            {
