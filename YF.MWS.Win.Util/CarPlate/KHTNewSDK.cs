...
{
    public partial class KHTNewSDK
    {
    ...
    public partial class KHTNewSDK
    {
        private const string sdkPath = "\\KHT\\WTY.dll";
        /************************************************************************/
        ...
        /*				数据。													*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_InitSDK", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*		Return Value:   void											*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_QuitSDK", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*		Return Value:   void											*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RegCLIENTConnEvent", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*							1	网络不通								*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_CheckStatus", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*		Return Value:   void											*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RegSerialDataEvent", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RegDataEx2Event", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_GetVehicleInfoEx", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*									时分秒-毫秒__颜色_车牌号码__.jpg	*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetSavePath", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*				  非0	失败											*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetTrigger", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*						  非0	失败									*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetTransContent", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*				设备继电器输出信号为：开关量信号。						*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetRelayClose", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RegJpegEvent", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*			  V5.2.1.0、V5.2.2.0、V5.2.6.0等版本不能使用此功能			*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RegAlarmEvent", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_RS485Send", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*							1	获取失败								*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_JpegMessageInit", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_GetJpegStream", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*							1	获取失败								*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_QuitDevice", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*				函数绑定与相机通讯的网卡IP								*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetNetworkCardBind", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*						  -1	失败									*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SnapJpegFrame", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*						  	非0	失败									*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetJpegStreamPlayOrStop", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*						  	非0	失败									*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SetDevTimeParam", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        ...
        /*						  	-1	失败									*/
        /************************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute(sdkPath, EntryPoint = "CLIENT_LPRC_SearchDeviceList", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
